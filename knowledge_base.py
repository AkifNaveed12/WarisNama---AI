...
# - Hanafi Faraid rules: Mulla's Mohammedan Law (1905, public domain) + the-legal.org
# - Shia Jafari rules: Zafar & Associates practice guide + Al-Syed Law resources
# - FBR Finance Act 2025 tables: fbr.gov.pk/overseas-faqs + taxationpk.com
# - PPC Sections: pakistancode.gov.pk
# - NADRA process: nadra.gov.pk
# - Arazi mutation process: punjab.gov.pk
# """
...
# # ============================================================================
# # SECTION 1: SUNNI HANAFI FARAID RULES (Mulla's Mohammedan Law + MFLO 1961)
# # Source: Mulla's Mohammedan Law, Chapter V (Inheritance), public domain edition
# # Also: Muslim Family Laws Ordinance 1961, Section 4 (pakistancode.gov.pk)
# # ============================================================================

# # Fixed shares (Quranic heirs) – fractions
# HANAFI_FIXED_SHARES = {
#     # Wife/Wives: 1/8 if children (or child's children), else 1/4
#     'wife_with_children': Fraction(1, 8),
#     'wife_no_children': Fraction(1, 4),
#     # Husband: 1/4 if children, else 1/2
#     'husband_with_children': Fraction(1, 4),
#     'husband_no_children': Fraction(1, 2),
#     # Mother: 1/6 if children or 2+ siblings, else 1/3 (if no children and no siblings)
...
#     # Father: minimum 1/6, then residue (Asaba)
#     'father_minimum': Fraction(1, 6),
#     # Daughter(s): 1/2 if single and no son, 2/3 if 2+ and no son
#     'daughter_sole': Fraction(1, 2),
#     'daughters_multiple': Fraction(2, 3),
# }

# # Asaba (residue) priority order – agnatic heirs who take remainder after fixed shares
...
# # MFLO 1961 Section 4 – Critical overrides
# # If a son predeceased the father, his children (grandchildren) inherit his share
# # This overrides classical Hanafi where grandchildren are excluded by living sons.
# MFLO_PREDECEASED_SON_RULE = True   # Always apply in Pakistan

# # ============================================================================
# # SECTION 2: SHIA JAFARI RULES (Zafar & Associates + Al-Syed Law)
# # Source: Zallp.com/practice/inheritance_law/ (retrieved 2025)
# # Key differences from Hanafi:
# #   - Wife does NOT inherit immovable property (land/buildings) – only movables
# #   - Radd (return) applies – surplus returns to heirs in proportion
# #   - Different priority for distant kindred
# # ============================================================================

# SHIA_RULES = {
#     # Wife exclusion from land/buildings
#     'wife_inherits_land': False,
#     'wife_only_movable': True,
#     # Radd (surplus return) – applies when fixed shares do not exhaust estate
#     'radd_applies': True,
#     # Daughter(s) as sole heir – surplus returns to daughter(s)
#     'daughter_sole_radd': True,
#     # Fixed shares (mostly same as Hanafi except where noted)
#     'husband_with_children': Fraction(1, 4),
#     'husband_no_children': Fraction(1, 2),
#     'wife_with_children': Fraction(1, 8),
#     'wife_no_children': Fraction(1, 4),
#     'mother': Fraction(1, 6),          # Always 1/6 in Shia (no 1/3 case)
#     'father': Fraction(1, 6),          # Always 1/6, then residue
#     # Daughter(s) – same fractions as Hanafi but with Radd
#     'daughter_sole': Fraction(1, 2),
#     'daughters_multiple': Fraction(2, 3),
#     # Distant kindred can inherit even when closer heirs exist (different rules)
#     'distant_kindred_inherit': True,
# }

# # ============================================================================
# # SECTION 3: CHRISTIAN INHERITANCE RULES (Succession Act 1925, Pakistan)
# # Source: Succession Act 1925, Part V (Intestate Succession) – pakistancode.gov.pk
# # Key: No gender discrimination, spouse gets 1/3 if children exist.
# # ============================================================================

# CHRISTIAN_RULES = {
#     # Distribution scenarios
#     'spouse_with_children': {
#         'spouse': Fraction(1, 3),
#         'children': Fraction(2, 3)      # split equally among all children (sons and daughters same)
#     },
#     'spouse_only': {
#         'spouse': Fraction(1, 1)
#     },
#     'children_only': {
#         'children': Fraction(1, 1)      # split equally
#     },
#     'no_spouse_no_children': {
#         # Parents first equally, then siblings, then half-blood, then grandparents
#         'parents': 'equal',      # both parents together take whole estate
#         'siblings': 'equal',
#         'half_blood': 'half_share_of_full_blood'
#     },
#     # No gender bias anywhere
#     'gender_equal': True,
# }

# # ============================================================================
# # SECTION 4: HINDU INHERITANCE RULES (Hindu Succession Act 1956 – applicable in Pakistan)
# # Source: Hindu Succession Act 1956, Class I and Class II heirs (pakistancode.gov.pk)
# # Note: For MVP, we provide basic principles and advise lawyer for coparcenary property.
# # ============================================================================

# HINDU_RULES = {
#     # Class I heirs – all inherit equally
#     'class_I_heirs': [
#         'widow', 'son', 'daughter', 'widow_of_predeceased_son',
#         'son_of_predeceased_son', 'daughter_of_predeceased_son',
#         'widow_of_predeceased_son_of_predeceased_son',  # etc.
#     ],
#     # Class II heirs (if no Class I)
#     'class_II_order': ['father', 'siblings', 'grandparents', 'uncles'],
#     # Coparcenary property (joint family) – special rules, not fully encoded in MVP
...
# # Source: FBR official FAQs – fbr.gov.pk/overseas-faqs (retrieved 2025)
# # Also cross-checked with taxationpk.com
# # ============================================================================
...
# # Capital Gains Tax (CGT) – inherited property gets stepped-up basis
# CGT_RULES = {
#     'before_30_june_2024': {
#         'year1': 0.15,      # 15% if sold within 1 year
#         'year2': 0.125,     # 12.5%
#         'year3': 0.10,
#         'year4': 0.075,
#         'year5': 0.05,
...
#     },
#     'after_1_july_2024': {
#         'filer_flat': 0.15,          # flat 15% for filers
#         'non_filer_sliding': {       # 15% to 45% based on value
#             'up_to_25M': 0.15,
#             '25M_to_50M': 0.20,
#             'over_50M': 0.45
#         }
#     },
#     'inherited_property_basis': 'FMV_at_inheritance',  # Step-up basis – no CGT on pre-inheritance gain
#     'cgt_only_on_post_inheritance_gain': True
# }

# # Other taxes
# CVT_RATE = 0.02           # Capital Value Tax (2% of property value, buyer pays once)
# STAMP_DUTY = {            # Province-dependent
#     'Punjab': 0.01,
#     'Sindh': 0.02,
#     'KPK': 0.015,
#     'Balochistan': 0.01,
#     'default': 0.01
# }
# REGISTRATION_FEE = 0.005  # 0.5% to 1%, use 0.5% as default
# SECTION_7E_RATE = 0.01    # Deemed income tax ~1% of market value per year (exempt if single self-occupied)
# FEDERAL_EXCISE_DUTY = 0.05  # 5% on first residential transfer
# INHERITANCE_TAX = 0.00    # CRITICAL: Pakistan has NO inheritance tax

# # ============================================================================
# # SECTION 6: DISPUTE & FRAUD PATTERNS (7 patterns as per blueprint)
# # Sources: PPC Section 498A, Succession Act 1925, Transfer of Property Act 1882,
# #          Guardians and Wards Act 1890, Islamic law on Wasiyyat (max 1/3)
# # ============================================================================

# DISPUTE_PATTERNS = {
#     # Pattern 1: Fraudulent Mutation (single heir transfers property to own name)
#     'fraudulent_mutation': {
#         'triggers': [
#             'mutation_by_single_heir',      # Only one heir applied for mutation
#             'no_succession_certificate'     # Mutation done without succession certificate
#         ],
#         'fraud_score': 87,
#         'law': 'PPC Section 498A (denying inheritance) + Succession Act 1925',
#         'penalty': '5-10 years imprisonment and fine',
#         'actions': [
#             'file_complaint_at_arazi_record_centre',
#             'file_fir_under_ppc_498a',
#             'send_legal_notice_to_patwari'
#         ],
#         'court': 'Civil Court (Declaratory Suit)',
#         'remedy': 'Mutation can be declared void; property restored to all heirs.'
#     },
#     # Pattern 2: Forced Partial Sale (one heir sells without others' consent)
#     'forced_partial_sale': {
#         'triggers': [
#             'one_heir_wants_to_sell',
#             'other_heirs_refuse',
#             'sale_already_done_without_consent'
#         ],
#         'fraud_score': 70,
#         'law': 'Transfer of Property Act 1882, Section 44 (co-owners cannot transfer without consent)',
#         'penalty': 'Sale is voidable at the option of other co-owners',
#         'actions': [
#             'send_legal_notice_to_buyer_and_seller',
#             'file_civil_suit_for_declaration_of_void_sale'
#         ],
#         'court': 'Civil Court',
#         'remedy': 'Court can declare sale void; property remains jointly owned.'
#     },
#     # Pattern 3: Invalid Hiba (Gift Deed without possession transfer)
#     'invalid_hiba': {
#         'triggers': [
#             'gift_deed_mentioned',
#             'donor_still_in_possession',   # Father still living in gifted house
#             'no_delivery_of_possession'
#         ],
#         'fraud_score': 65,
#         'law': 'Muslim Personal Law (Shariat) Application Act 1962 – Hiba requires offer, acceptance, and delivery of possession',
#         'penalty': 'Hiba is invalid if possession not transferred',
#         'actions': [
#             'challenge_hiba_in_civil_court',
#             'send_legal_notice_to_donee'
#         ],
#         'court': 'Civil Court',
#         'remedy': 'Court can declare Hiba invalid; property returns to estate.'
#     },
#     # Pattern 4: Excessive Wasiyyat (Will exceeding 1/3 of estate)
#     'excessive_wasiyyat': {
#         'triggers': [
#             'will_mentioned',
#             'will_percentage_greater_than_33.33'
#         ],
#         'fraud_score': 60,
#         'law': 'Islamic law (all sects) – Wasiyyat valid only up to 1/3 of estate after debts',
#         'penalty': 'Excess portion is void; distributed among legal heirs via Faraid',
#         'actions': [
#             'explain_1/3_rule',
#             'recalculate_valid_shares',
#             'generate_legal_notice_to_executor'
#         ],
#         'court': 'Civil Court (if executor refuses to comply)',
#         'remedy': 'Will is partially enforceable; remaining 2/3 distributed by Faraid.'
#     },
#     # Pattern 5: Debt Priority Violation (heirs distribute before paying debts)
#     'debt_priority_violation': {
#         'triggers': [
#             'debts_mentioned',
#             'estate_distributed_before_debt_payment'
#         ],
#         'fraud_score': 90,
#         'law': 'Islamic law and Succession Act – debts and funeral expenses take priority over inheritance',
#         'penalty': 'Heirs may be personally liable for unpaid debts',
#         'actions': [
#             'stop_distribution',
#             'pay_all_debts_first',
#             'then_distribute_remainder'
#         ],
#         'court': 'Civil Court (creditors can sue heirs)',
#         'remedy': 'Correct order: Funeral → Debts → Wasiyyat (max 1/3) → Faraid.'
#     },
#     # Pattern 6: Minor Heir Present (under 18 or 21 for guardian purposes)
#     'minor_heir': {
#         'triggers': [
#             'heir_age_under_18',
#             'no_legal_guardian_appointed'
#         ],
#         'fraud_score': 50,
...
#         'actions': [
#             'apply_to_district_court_for_guardian_appointment',
#             'file_guardian_application_with_heir_list'
#         ],
#         'court': 'District Court (Guardian Judge)',
#         'remedy': 'Guardian appointed; then normal succession process.'
#     },
#     # Pattern 7: Buy-Out Negotiation (one heir wants to keep property, others want cash)
#     'buyout_negotiation': {
#         'triggers': [
#             'one_heir_wants_to_keep',
#             'others_want_cash',
#             'mutual_agreement_possible'
#         ],
#         'fraud_score': 0,   # Not fraud, but a dispute pattern
#         'law': 'Transfer of Property Act – internal transfer allowed with all heirs\' NOC',
#         'penalty': 'None if done legally',
#         'actions': [
#             'calculate_buyout_amount_per_heir',
#             'generate_buyout_agreement',
#             'calculate_stamp_duty_and_236K_for_internal_transfer'
#         ],
...
# # ============================================================================
# # SECTION 7: LEGAL TEMPLATES (for document generation)
# # Source: Gemini generated – based on standard Pakistani legal notice formats
# # ============================================================================
...
# Sir/Madam,
# Your action of {fraud_description} is illegal under {law_section}. You are hereby directed to {remedy} within 15 days of receiving this notice. Failure to comply will result in legal proceedings against you without further notice.
...
# # ============================================================================
# # SECTION 8: NADRA & COURT PROCESS STEPS (for Process Navigator module)
# # Sources: nadra.gov.pk (Succession Certificate), punjab.gov.pk (Arazi mutation)
# # ============================================================================
...
#         'authority': 'NADRA Succession Cell OR Civil Court (District Court)',
#         'fee': 'Rs 2,000 – 5,000 (approx)',
#         'documents': ['Death certificate', 'CNICs of all heirs', 'Property/asset details', 'Family registration certificate'],
...
#         'fee': 'Nominal (Rs 500 – 2000)',
#         'documents': ['Succession certificate', 'Death certificate', 'Original property deed (Fard/Intiqal)', 'CNICs of all heirs'],
...
# # Add this section at the end of knowledge_base.py (before the helper functions)

# # ============================================================================
# # REFERENCES for each rule (to show users where the law comes from)
# # ============================================================================

# REFERENCES = {
#     # Hanafi
#     'hanafi_wife_with_children': "Mulla's Mohammedan Law, Chapter V, Section 272: Wife gets 1/8 if deceased has children (or grandchildren).",
...
#     'hanafi_asaba_children': "Hanafi Asaba (residue) rule: Sons and daughters divide residue with son getting double daughter's share. (Mulla's, Section 281-285)",
#     'hanafi_mflo_predeceased_son': "Muslim Family Laws Ordinance 1961, Section 4: Predeceased son's children inherit his share (overrides classical Hanafi). Source: pakistancode.gov.pk",
...
#     # Christian
#     'christian_spouse_children': "Succession Act 1925, Section 33(c): Spouse gets 1/3, children get 2/3 equally (no gender distinction).",
...
# # ============================================================================
# # SECTION 9: HELPER FUNCTIONS FOR TAX BRACKET DETECTION ETC.
# # ============================================================================
...
CGT_RULES = {
    'before_30_june_2024': {'year1': 0.15, 'year2': 0.125, 'year3': 0.10, 'year4': 0.075, 'year5': 0.05, 'year6_plus': 0.00},
    'after_1_july_2024': {'filer_flat': 0.15, 'non_filer_sliding': {'up_to_25M': 0.15, '25M_to_50M': 0.20, 'over_50M': 0.45}},
...
# ============================================================================
# SECTION 7: LEGAL REFERENCES (to display to users)
# ============================================================================
...
# ============================================================================
# SECTION 10: LEGAL DOCUMENT TEMPLATES (for document generation)
# Source: Gemini generated – based on standard Pakistani legal notice formats
# ============================================================================
